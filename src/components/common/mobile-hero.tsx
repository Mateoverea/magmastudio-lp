...
const MobileHero = () => {
  ...
  const { getArray } = useTranslationArray("mobile_hero.services"); // Para los servicios
  const services = getArray(); // Obtener los servicios traducidos
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-start px-2 flex-1 justify-center">
        ...
        >
          <span className="block">{t("mobile_hero.title_part1")}</span>
          ...
          >
            ...
            >
              ...
              <span className="relative z-10 flex items-center justify-center gap-3">
                ...
                <span className="group-hover:text-[#d85a00] transition-colors duration-300 uppercase">{t("mobile_hero.cta_button")}</span>
              </span>
            </button>
          </Link>
        </div>
