  ...
  const onSubmit = async (values: z.infer<typeof leadFormSchema>) => {
    startTransition(async () => {
      ...
      if (result.success) {
        ...
        toast.success("El recurso será enviado a tu bandeja de entrada");
      } else {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <div className=" w-full md:w-fit">
          <DialogHeader>
            <DialogTitle>
              La Guía <br className=" hidden md:block" />
              <span className=" text-[#FF4500]">Definitiva</span> para{" "}
              <br className=" hidden md:block" />
              el Éxito de tu MVP
            </DialogTitle>
            <DialogDescription>
              Obtén consejos exclusivos y asesoramiento experto para crear un MVP potente.
              ¡Reclama tu guía PDF gratuita hoy!
            </DialogDescription>
          </DialogHeader>
            ...
            >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className=" w-full">
                    <FormLabel>
                      Correo Electrónico <span className=" text-[#FF4500]">*</span>
                    </FormLabel>
                    <FormControl>
                      <Input
                        disabled={isPending}
              ...
              <Button type="submit" className=" w-full mt-8">
                {isPending ? "Procesando..." : "Obtener Guía Gratuita"}
                {isPending ? (
