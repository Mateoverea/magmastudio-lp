...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen w-full md:px-10">
      ...
      <div ref={ref} className="relative w-full max-w-4xl mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            ...
            <div className="sticky top-28 flex flex-col items-center w-full z-50">
              ...
              >
                <div className="md:max-w-lg">
                  ...
                  <h3 className=" mt-4 text-3xl md:text-5xl font-semibold font-cabinetGrotesk fon text-white max-w-[10ch]">
                    {item.title}
                  </h3>

                  <h4 className=" text-white text-lg md:text-xl font-archivo mt-2 opacity-80 max-w-[35ch]">
                    {item.description}
                  </h4>
                </div>
              </div>
